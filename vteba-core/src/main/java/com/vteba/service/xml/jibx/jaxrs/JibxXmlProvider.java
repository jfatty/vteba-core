package com.vteba.service.xml.jibx.jaxrs;
...
public class JibxXmlProvider implements MessageBodyReader<Object>, MessageBodyWriter<Object> {
	...
	public boolean isWriteable(Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType) {
        ...
        if (cfgCheckCanSerialize) {
            if (!xmlServiceImpl.canSerialize(type)) {
                return false;
            }
        }
        return true;
	...
	public void writeTo(Object t, Class<?> type, Type genericType, Annotation[] annotations, MediaType mediaType,
		...
		xmlServiceImpl.objectToXml(t, streamResult);
	}
	...
	public Object readFrom(Class<Object> type, Type genericType, Annotation[] annotations, MediaType mediaType,
		...
		Object object = xmlServiceImpl.xmlToObject(streamSource, type);
		return object;
	}
